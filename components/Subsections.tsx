  ...
  return (
    <div className="max-w-6xl mx-auto p-4 text-center" id="features">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mt-2 text-gray-900">Cloud Storage + Search</h1>
      ...
      <div className="flex flex-col md:flex-row items-center mb-8">
        ...
        <div className="ml-0 md:ml-8 w-full md:w-1/2 text-left flex items-center px-8 py-4">
          <p className="text-lg text-gray-600">
            Upload PDFs, ePUBs, YouTube videos, Google Docs, Obsidian or Notion notes and we&apos;ll turn them into a search engine for you
          </p>
        </div>
      </div>
